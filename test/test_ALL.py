...
import unittest2
from risk_report.blp import getLongHoldings, getConsolidatedHoldings
...
class TestALL(unittest2.TestCase):
	...
	def testGetLongHoldings(self):
		...
		holdings = list(getLongHoldings(inputFile))
	...
	def testGetConsolidatedHoldings(self):
		inputFile = join(getCurrentDirectory(), 'samples', 'risk_m2_sample.xls')
		clo, nonCLO = getConsolidatedHoldings(inputFile)
